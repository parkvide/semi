  ...
  <body>
    ...
    <main>
      ...
      <div class="detail">
        ...
        <div class="sep1"></div>
        <dl>
          <dt>상품구성</dt><dd>${vo.name}</dd>
          <dt>유효기간</dt><dd>구매일로부터 1년</dd>
          <dt>원산지</dt><dd>${vo.type}(${vo.originCountry})</dd>
          <dt>상품교환</dt><dd><a href="">각 매장 스토어</a></dd>
        </dl>
        <div class="sep2"></div>
        <div>
          <div class="cnt">
          ...
          <div class="sep3"></div>
          <div class="total-price"><span>총 구매금액 개수 * ${vo.price} 원</span></div>
        </div>
        <div class="buy-btn">
          <button>장바구니</button>
