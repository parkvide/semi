...
<nav>
    ...
    <div class="prd-list">
        <div class="prd-title">
            ...
            <span class="prd-detail">마음을 담아 선물하세요</span>
        </div>
        <div class="sep2"></div>
        <ul class="list-style">
            <li>
                <a href="">
                    <span><img height="270" width="270" src="/app/resources/img/패키지/나랑너패키지.jpg" alt=""></span>
            ...
            <li>
                <a href="">
                    <span><img height="270" width="270" src="/app/resources/img/패키지/우리패키지.jpg" alt=""></span>
            ...
            <li>
                <a href="">
                    <span><img height="270" width="270" src="/app/resources/img/패키지/좋은날패키지.jpg" alt=""></span>
